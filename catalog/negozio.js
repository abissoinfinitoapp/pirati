...
PIRATI.registerNegozio([
  ...
  /* --- Action figure: eroi dei cartoni (personaggi inventati, generici) - */
  { id: "pompiere-coraggioso", name: "Action Figure «Il Pompiere Coraggioso»", categoria: "cartoni", price: 400, perPrestigio: 480, art: "stylized plastic action figure of a chunky cartoon firefighter: red helmet, yellow jacket with reflective stripes, sturdy boots, holding a small coiled hose, confident heroic stance, cheerful face, invented character, no resemblance to any real character, toy photography on white" },
  { id: "bestiola-cobalto",  name: "Action Figure «La Bestiola Turbo Cobalto»", categoria: "cartoni", price: 400,  perPrestigio: 480, art: "stylized plastic action figure of a small cobalt-blue cartoon pangolin with overlapping scaly armour, leaning into a running pose, confident smile, invented creature, no resemblance to any real character, toy photography on white" },
  { id: "bradipo-avventuriero", name: "Action Figure «Il Bradipo Avventuriero»", categoria: "cartoni", price: 500,  perPrestigio: 440, art: "stylized plastic action figure of a smiling three-toed sloth standing upright as an adventurer, holding a wooden walking staff, wearing a small leaf hat and a tiny explorer vest, calm and confident pose, invented character, no resemblance to any real character, toy photography on white" },
  { id: "maga-stelline",     name: "Action Figure «La Maghetta delle Stelline»", categoria: "cartoni", price: 450, perPrestigio: 460, art: "stylized plastic action figure of a cheerful magical girl holding a star wand, pastel pink and lilac outfit, tiny wings, invented character, no resemblance to any real character, toy photography on white" },
  { id: "robottone-gigante", name: "Action Figure «Il Robottone Gigante»", categoria: "cartoni", price: 900, perPrestigio: 300, art: "stylized chunky retro tin-style toy robot, boxy body, single antenna, a light-up panel on the chest, big stompy pose, primary colors, generic robot, invented character, no resemblance to any real character, toy photography on white" },

  /* --- Action figure: eroi ed esploratori (generici) ---------------- */
  { id: "supereroe-mantello", name: "Action Figure «Il Supereroe dal Mantello Rosso»", categoria: "eroi", price: 700, perPrestigio: 360, art: "stylized plastic superhero action figure with a flowing red cape, plain blue bodysuit, no chest symbol, heroic pose, generic superhero, invented character, no resemblance to any real character, toy photography on white" },
  { id: "difensore-mascherato", name: "Action Figure «Il Difensore Mascherato»", categoria: "eroi", price: 700,  perPrestigio: 360, art: "stylized plastic action figure of a masked hero, simple domino mask, plain green and grey bodysuit with no pattern, fists raised, ready stance, generic masked hero, invented character, no resemblance to any real character, toy photography on white" },
  { id: "cavaliere-argento", name: "Action Figure «Il Cavaliere d'Argento»", categoria: "eroi", price: 800, perPrestigio: 340, art: "stylized plastic action figure of a medieval knight in silver plate armour, plumed helmet, holding a plain steel sword and a round shield, heroic stance, generic knight, invented character, no resemblance to any real character, toy photography on white" },
  { id: "esploratrice-zaino", name: "Action Figure «L'Esploratrice dello Zaino»", categoria: "eroi", price: 350, perPrestigio: 500, art: "stylized plastic action figure of a cartoon explorer with a large backpack and a folded map, plain safari outfit and wide-brim hat, curious pose, generic explorer, invented character, no resemblance to any real character, toy photography on white" },
